...
context file at the repo root (read directly by Codex/OpenCode/Antigravity CLI;
...
class CodexAdapter(HarnessAdapter):
    ...
    def emit_global(self, plugins: list[PluginSource]) -> EmitResult:
        ...
        by Codex / OpenCode / Antigravity CLI; Claude Code reads it via
        ...
        if not agents_md.is_file():
            result.warnings.append(
                ...
                "context file for Codex/OpenCode/Antigravity CLI; Claude Code reads"
