...
Plugin content in this repo ships to **five** harnesses: OpenAI Codex CLI, OpenCode, the Google Antigravity CLI (`agy`), GitHub Copilot, and Pi. Claude Code is the source-of-truth. The adapter framework handles per-harness
...
the native tool from the action you describe. OpenCode is strict about lowercase (`read`, `bash`).
...
|---|---|---|---|---|---|
| `model: fable` | `gpt-5.5` | `anthropic/claude-fable-5` | `pro` | `claude-fable-5` | `anthropic/claude-fable-5` |
| `model: opus` | `gpt-5.5` | `anthropic/claude-opus-4-8` | `pro` | `claude-opus-4.8` | `anthropic/claude-opus-4-8` |
| `model: sonnet` | `gpt-5.4-mini` | `anthropic/claude-sonnet-5` | `pro` | `claude-sonnet-5` | `anthropic/claude-sonnet-5` |
| `model: haiku` | `gpt-5.4-mini` | `anthropic/claude-haiku-4-5` | `flash` | `claude-haiku-4.5` | `anthropic/claude-haiku-4-5` |
| `model: inherit` | `gpt-5.5` | `anthropic/claude-sonnet-5` | `inherit` | `claude-sonnet-5` | `inherit` |
